...
- Desenvolvimento com **React e Angular**
- Consumo e criação de **APIs REST**
- Implementação de **CRUD** completo
- Integração com banco de dados **MySQL**
- Projetos fullstack com **Node.js e PHP (básico)**
...
💼 https://www.linkedin.com/in/adsonpereira

---

## 📍 Objetivo

Busco minha primeira oportunidade como **Desenvolvedor de Software**, onde eu possa aprender, evoluir tecnicamente e contribuir com soluções reais em um ambiente colaborativo.
